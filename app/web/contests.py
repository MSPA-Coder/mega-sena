...
from . import bp
from .helpers import is_htmx_request, optional_int, plural, render_htmx, render_page
...
def contests():
    ...
    if is_htmx_request():
        return render_htmx("contests/_results.html", **context)
    return render_page("contests/index.html", **context)
