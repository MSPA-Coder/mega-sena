...
# Teto das colunas BigInteger (int8) e limite padrão de parse_int, usado
# quando o valor não é gravado em uma coluna Integer comum.
MAX_INT64 = (1 << 63) - 1
...
def count_consecutive_numbers(numbers: Iterable[int]) -> int:
    ...
    longest = 0
    current = 1
    # `strict=False` é o correto aqui: as duas sequências têm tamanhos
    # diferentes por construção — a segunda é a primeira deslocada em um —, e
    # parar na mais curta é exatamente o que percorre os pares consecutivos.
